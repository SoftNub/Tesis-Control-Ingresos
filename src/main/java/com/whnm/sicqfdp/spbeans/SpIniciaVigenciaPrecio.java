 ...
 * @author wilson
 */
public class SpIniciaVigenciaPrecio extends StoredProcedure {
    public static final String SPROC_NAME = "mi_sp_inicia_vigencia_precio";
    public static final String PARAM_IN_FECHA_SIST = "_fecha_sist";
    ...
    public SpIniciaVigenciaPrecio(DataSource dataSource) {
