 ...
 * @author wilson
 */
public class SpListarProvinciasHabilitados extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_provincias_habilitados";
    ...
    public SpListarProvinciasHabilitados(DataSource dataSource) {
