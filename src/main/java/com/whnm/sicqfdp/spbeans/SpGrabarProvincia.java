 ...
 * @author wilson
 */
public class SpGrabarProvincia extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_grabar_provincia";
    ...
    public SpGrabarProvincia(DataSource dataSource) {
