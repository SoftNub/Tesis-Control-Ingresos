 ...
 * @author wilson
 */
public class SpListarEstadoCivil extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_estCiviles";
    public static final String PARAM_IN_IDESTADOCILVIL = "codEstadoCivil";
    ...
    public SpListarEstadoCivil(DataSource dataSource) {
        super(dataSource, SPROC_NAME);
        declareParameter(new SqlParameter(PARAM_IN_IDESTADOCILVIL, Types.INTEGER));
