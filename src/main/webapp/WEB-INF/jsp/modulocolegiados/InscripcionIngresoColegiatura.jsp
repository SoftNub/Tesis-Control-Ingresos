...
<html>
    <head>
        ...
        <script src="<%=request.getContextPath()%>/js/modulocolegiado/AdmColegiado.js"></script>
    </head>
    <body>
        <header>
            <nav>
        ...
        <section class="container">
            ...
            <div class="row form-group"> 
                <div class="col-lg-offset-6 col-lg-3">
                    <select class="form-control" id="cboIngresoInscripcion" tabindex="1">
...
<!--                    <div class="input-group">-->
                        <input type="text" class="form-control" id="txtDni"
                               placeholder="Ingrese DNI" tabindex="2" maxlength="8">
                            ...
                            <div class="panel-body">
                                <div class="row form-group"> 
                                    ...
                                    <div class="col-lg-offset-2 col-lg-3">
                                        <label>Fecha Ingreso / Inscripcion DD/MM/YYYY (*):</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control" id="txtFechaIngresoInscripcion" 
                                               placeholder = "Fecha Ingre./Incrip." tabindex="4" maxlength="10">
                                    </div>
                                </div>
                                <div class="row form-group"> 
                                    <div class="col-lg-1">
                                ...
                                <div class="row form-group"> 
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" class="form-control" id="txtCarnetExtranjeria"
                                               placeholder = "Carnet Extranjeria" tabindex="17" maxlength="20">
                                    </div>
                                    <div class="col-lg-3">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row form-group"> 
                                    ...
                                    <div class="col-lg-2">
                                        <label for="añoTitulo">Fecha :</label>
...
<!--                                            <div class="row">
                                ...
                                <div class="row form-group"> 
                                    <div class="col-lg-4">
                                        <label for="socCientificasNac">Soc. Cientificas Nacionales: <button type="button" id = "btnSocNacionales" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span></button></label>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    <div class="col-lg-offset-9 col-lg-3">
                                        ...
                                        <!--<a class="btn btn-primary btn-block" data-toggle="tab" href="#datosFamiliares" accesskey="a">&LT;&LT; Anterior</a>-->
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--            <div class="row">
                ...
                <div class="col-lg-3">
                    <button type="button" class="btn btn-primary btn-block">Limpiar</button>
                </div>
            </div>-->
        </section>
        <footer>
