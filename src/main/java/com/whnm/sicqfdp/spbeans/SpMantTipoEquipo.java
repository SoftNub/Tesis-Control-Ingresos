 ...
 * @author wilson
 */
public class SpMantTipoEquipo extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_mant_tipoequipo";
    public static final String PARAM_IN_IDTIPOEQUIPO = "codTipoEquipo";
    public static final String PARAM_IN_DESCTIPOEQUIPO = "descTipoEquipo";
    ...
    public SpMantTipoEquipo(DataSource dataSource) {
        super(dataSource, SPROC_NAME);
        declareParameter(new SqlParameter(PARAM_IN_IDTIPOEQUIPO, Types.INTEGER));
        declareParameter(new SqlParameter(PARAM_IN_DESCTIPOEQUIPO, Types.VARCHAR));
