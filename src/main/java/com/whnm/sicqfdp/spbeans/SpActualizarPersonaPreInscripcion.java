 ...
 * @author wilson
 */
public class SpActualizarPersonaPreInscripcion extends StoredProcedure {
    public static final String SPROC_NAME = "mc_sp_actualizar_persona";
    ...
    public SpActualizarPersonaPreInscripcion(DataSource dataSource) {
