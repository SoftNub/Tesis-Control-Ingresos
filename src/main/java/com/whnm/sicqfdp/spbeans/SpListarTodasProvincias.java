 ...
 * @author wilson
 */
public class SpListarTodasProvincias extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_all_provincias";
    public static final String PARAM_OUT_IND = "ind";
    public static final String PARAM_OUT_MSJ = "msj";
    
    public SpListarTodasProvincias(DataSource dataSource) {
