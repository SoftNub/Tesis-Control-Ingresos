 ...
 * @author wilson
 */
public class SpListarCondicionCasa extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_condCasa";
    public static final String PARAM_IN_IDCONDICIONCASA = "codCondCasa";
    ...
    public SpListarCondicionCasa(DataSource dataSource) {
