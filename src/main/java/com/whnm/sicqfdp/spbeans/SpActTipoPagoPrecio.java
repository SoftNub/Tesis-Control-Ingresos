 ...
 * @author wilson
 */
public class SpActTipoPagoPrecio extends StoredProcedure {
    public static final String SPROC_NAME = "mi_sp_actuliza_precios";
    public static final String PARAM_IN_IDPAGO = "_id_pago";
    public static final String PARAM_IN_IND_TABLA_ACTUAL = "ind_tabla_act";
    public static final String PARAM_IN_IND_TABLA_TEMP = "ind_tmp_precio";
    public static final String PARAM_IN_PRECIO = "precio_nuevo";
    public static final String PARAM_IN_FECHA_VIG = "fecha_vig_nuevo";
    ...
    public SpActTipoPagoPrecio(DataSource dataSource) {
        super(dataSource, SPROC_NAME);
        declareParameter(new SqlParameter(PARAM_IN_IDPAGO, Types.INTEGER));
        declareParameter(new SqlParameter(PARAM_IN_IND_TABLA_ACTUAL, Types.INTEGER));
        declareParameter(new SqlParameter(PARAM_IN_IND_TABLA_TEMP, Types.INTEGER));
