 ...
 * @author wilson
 */
public class SpListarDepartamento extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_departamento";
    ...
    public SpListarDepartamento(DataSource dataSource) {
