 ...
 * @author wilson
 */
public class SpListarDistritosProvincia extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_distrito_x_provincia";
    ...
    public SpListarDistritosProvincia(DataSource dataSource) {
