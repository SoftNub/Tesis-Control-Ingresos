 ...
 * @author wilson
 */
public class SpEliminarDepartamento extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_eliminar_departamento";
    ...
    public SpEliminarDepartamento(DataSource dataSource) {
