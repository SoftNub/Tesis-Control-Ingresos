 ...
 * @author wilson
 */
public class SpMantDeuda extends StoredProcedure {
    public static final String SPROC_NAME = "mi_sp_mant_pago_inhabilitador";
    ...
    public SpMantDeuda(DataSource dataSource) {
