 ...
 * @author wilson
 */
public class SpListarProvinciasDepartamento extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_provincia_x_departamento";
    ...
    public SpListarProvinciasDepartamento(DataSource dataSource) {
