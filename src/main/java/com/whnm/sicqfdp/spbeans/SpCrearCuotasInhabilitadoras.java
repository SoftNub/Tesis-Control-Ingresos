 ...
 * @author wilson
 */
public class SpCrearCuotasInhabilitadoras extends StoredProcedure {
    public static final String SPROC_NAME = "mi_pagos_inhab_mensuales_proc";
    public static final String PARAM_IN_FECHA_SIST = "fecha_proc";
    ...
    public SpCrearCuotasInhabilitadoras(DataSource dataSource) {
        super(dataSource, SPROC_NAME);
        declareParameter(new SqlParameter(PARAM_IN_USUARIO, Types.VARCHAR));
        declareParameter(new SqlParameter(PARAM_IN_FECHA_SIST, Types.VARCHAR));
