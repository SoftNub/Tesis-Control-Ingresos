 ...
 * @author wilson
 */
public class SpConsultarUsuario extends StoredProcedure {
    public static final String SPROC_NAME = "ms_sp_con_para_usuario";
    public static final String PARAM_IN_OPC = "_tipo_consulta";
    public static final String PARAM_IN_USERNAME = "id_col_per";
    public static final String PARAM_OUT_IND = "ind";
    public static final String PARAM_OUT_MSJ = "msj";
    
    public SpConsultarUsuario(DataSource dataSource) {
