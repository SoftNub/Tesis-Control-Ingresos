 ...
 * @author wilson
 */
public class SpListarProvincia extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_provincia";
    ...
    public SpListarProvincia(DataSource dataSource) {
