 ...
 * @author wilson
 */
public class SpGrabarDistrito extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_grabar_distritos";
    ...
    public SpGrabarDistrito(DataSource dataSource) {
