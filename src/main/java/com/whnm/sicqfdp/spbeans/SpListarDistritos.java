 ...
 * @author wilson
 */
public class SpListarDistritos extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_distritos";
    ...
    public SpListarDistritos(DataSource dataSource) {
