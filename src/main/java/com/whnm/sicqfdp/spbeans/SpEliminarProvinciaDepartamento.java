 ...
 * @author wilson
 */
public class SpEliminarProvinciaDepartamento extends StoredProcedure{
    public static final String SPROC_NAME = "mg_sp_eliminar_provincia_x_departamento";
    ...
    public SpEliminarProvinciaDepartamento(DataSource dataSource) {
