 ...
 * @author wilson
 */
public class SpListarTipoEquipo extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_tipoequipo";
    ...
    public SpListarTipoEquipo(DataSource dataSource) {
