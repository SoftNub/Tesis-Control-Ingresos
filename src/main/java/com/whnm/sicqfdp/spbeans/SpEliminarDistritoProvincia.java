 ...
 * @author wilson
 */
public class SpEliminarDistritoProvincia extends StoredProcedure{
    public static final String SPROC_NAME = "mg_sp_eliminar_distritos_x_provincia";
    ...
    public SpEliminarDistritoProvincia(DataSource dataSource) {
