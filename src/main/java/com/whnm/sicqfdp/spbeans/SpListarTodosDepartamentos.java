 ...
 * @author wilson
 */
public class SpListarTodosDepartamentos extends StoredProcedure {
    public static final String SPROC_NAME = "mg_sp_listar_all_departamentos";
    public static final String PARAM_OUT_IND = "ind";
    public static final String PARAM_OUT_MSJ = "msj";
    
    public SpListarTodosDepartamentos(DataSource dataSource) {
